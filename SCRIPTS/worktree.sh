...
VALID_PROJECTS="DNA SIM/HELIOS SIM/TOOFOO SIM/HANDTRACK WELCOME SW/AUTOCRATE SW/CHLADNI SW/PORTFOLIO TOOLS/SIMULATION_CLI TOOLS/STORAGE_SERVER TOOLS/PLL BLOG LEARN PROJECT_N infra"
