...
impl GitHubClient {
    ...
    pub async fn get_pr_comments(&self, pr_number: u64, since: Option<String>) -> Result<Vec<Comment>> {
        let pr = self.client
        ...
        for comment in comments.items {
            ...
            if let Some(ref body) = comment.body {
                if body.contains("Generated by Claude") || body.starts_with("🔧") || body.starts_with("✅") {
                    continue;
                }
            }
        ...
        for comment in comments.items {
            ...
            if let Some(ref body) = comment.body {
                ...
                if body.contains("Generated by Claude Automation") ||
                   ...
                   body.starts_with("✅") ||
                   body.starts_with("📋") ||
                   body.starts_with("##") {  // Agent responses often start with markdown headers
                    continue;
                }
            }
            ...
            if comment.user.login == self.owner {
                if let Some(ref body) = comment.body {
                    if body.contains("🤖") || body.contains("*Generated by Claude") {
                        continue;
                    }
                }
            }
