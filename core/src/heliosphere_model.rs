use glam::Vec3;
use crate::solar_wind::{NumberTimeSeries, Vector3TimeSeries, PROTON_MASS, BOLTZMANN};
...
impl HeliospherePhysicsModel {
    pub fn new() -> Self {
        Self {
            ...
            magnetic_field_strength: Vector3TimeSeries::new(vec![0.0], vec![Vec3::new(0.0, 0.0, 5.0)]),
